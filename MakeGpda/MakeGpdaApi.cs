...
public class MakeGpdaApi {
    public static void MakeGpda(string lstDir) { _ = MakeGpda(lstDir, Directory.GetCurrentDirectory()); }

    public static async Task MakeGpda(string lstDir, string workingDir) {
        ...
        await using (BinaryWriter writer = new(File.Open(targetFile, FileMode.Create, FileAccess.Write))) {
            ...
            foreach (FileNameStruct fn in fileNames) {
                ...
                if (fn.NameSize > fn.InternalName.Length) {
